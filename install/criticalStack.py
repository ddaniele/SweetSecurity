...
def install(csKey):
	...
	if cpuArch == 'x86':
		os.popen('sudo wget https://intel.criticalstack.com/client/critical-stack-intel-i386.deb 2>&1').read()
		...
		subprocess.run(['sudo', '-u', 'critical-stack', 'critical-stack-intel', 'api', csKey], check=True)
		print("  Cleaning Up Installation Files")
		os.remove('critical-stack-intel-i386.deb')
	elif cpuArch == 'x86_64':
		os.popen('sudo wget https://intel.criticalstack.com/client/critical-stack-intel-amd64.deb 2>&1').read()
		...
		os.popen('sudo wget https://intel.criticalstack.com/client/critical-stack-intel-arm.deb 2>&1').read()
